...
- Mean EM confidence-weight vs correctness corr = 0.2871.
- Corr(mu_update_norm, correctness) = 0.2935.
- Mean prototype drift from init moved from ~0.0032 (early) to ~0.0393 (late).
- Prediction churn = 0.0000, recovery latency = 1.2500.
