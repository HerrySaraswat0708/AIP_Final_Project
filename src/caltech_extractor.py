...
def _load_caltech_split(preprocess):
    split_path = Path("data/splits/split_zhou_Caltech101.json")
    root_candidates = [
        Path("data/raw/CALTECH_clean/caltech101/101_ObjectCategories"),
        Path("data/raw/CALTECH_fresh/caltech101/101_ObjectCategories"),
        Path("data/raw/CALTECH/caltech101/101_ObjectCategories"),
    ]
...
def extract_caltech():
    ...
    split_loaded = _load_caltech_split(preprocess=preprocess)
